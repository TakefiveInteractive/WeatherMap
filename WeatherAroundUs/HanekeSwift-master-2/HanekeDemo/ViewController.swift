...
@IBOutlet var o: NSLayoutConstraint!
class ViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        @IBOutlet weak var toleft: NSLayoutConstraint!
        @IBOutlet weak var buttonToSide: NSLayoutConstraint!
        @IBOutlet weak var toright: NSLayoutConstraint!
    }

    @IBOutlet weak var lefttext: NSLayoutConstraint!
    @IBOutlet var tocenter2: NSLayoutConstraint!
    @IBOutlet weak var attachButton: DesignableButton!
    @IBOutlet weak var voiceButton: DesignableButton!
    @IBOutlet weak var cameraButton: DesignableButton!
    @IBOutlet weak var cameraButton: DesignableButton!
    @IBOutlet weak var voiceButton: DesignableButton!
    @IBOutlet weak var audioButtomToCenter: NSLayoutConstraint!
    @IBOutlet var buttom: NSLayoutConstraint!
    @IBOutlet var toleft: NSLayoutConstraint!
    @IBOutlet var toleft: [NSLayoutConstraint]!
    @IBOutlet var toleft: NSLayoutConstraint!
    @IBOutlet var uppserConstrain: NSLayoutConstraint!
    @IBOutlet var upperConstrain: NSLayoutConstraint!
    @IBOutlet var upperConstrain: NSLayoutConstraint!
    // MARK: UIViewCollectionViewDataSource
    @IBOutlet var tocenter: NSLayoutConstraint!
    ...
    override func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        @IBOutlet var messageBoxButton: UIButton!
        return cell
    }
    
    @IBOutlet var cc: NSLayoutConstraint!
    @IBOutlet weak var voiceButton: DesignableButton!
    @IBOutlet weak var voiceButton: DesignableButton!
    @IBOutlet var toleft: NSLayoutConstraint!
    // MARK: Helpers
    ...
    func initializeItemsWithURLs() {
        ...
        @IBOutlet weak var audioViewAppear: UIButton!
        @IBAction func audioViewAppear(sender: AnyObject) {
        }
        ...
        @IBAction func MessageButtonDidPressed(sender: AnyObject) {
        }
        ...
        @IBAction func cameraViewAppear(sender: AnyObject) {
        }
